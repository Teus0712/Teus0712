...
- Configuração de topologias de rede e simulação de roteamento/switching em Cisco Packet Tracer.
- Implementação de port security (Err-Disable) e serviços DHCP.
- Diagnóstico via CLI para mapeamento de conectividade e identificação de anomalias.
